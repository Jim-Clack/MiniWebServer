...
public class PreferencesTest extends TestCase {
    ...
    public void testPortNumber() {
        ...
        Assert.assertEquals(888, Preferences.getInstance().getPortNumber());
        Preferences.getInstance().setPortNumber(777);
        Assert.assertEquals(777, Preferences.getInstance().getPortNumber());
    ...
    public void testSslPortNumber() {
        ...
        Preferences.getInstance().reset();
        Assert.assertEquals(888, Preferences.getInstance().getSslPortNumber());
        Preferences.getInstance().setSslPortNumber(777);
        Assert.assertEquals(777, Preferences.getInstance().getSslPortNumber());
