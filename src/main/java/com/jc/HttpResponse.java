...
public class HttpResponse extends HttpResponseBase implements IHttpResponse {
    ...
    private void loadFile(Path pathToFile) {
        ...
        if(content != null && content.length > 0) {
            generateHeaders(content.length);
    ...
    private void generateHeaders(int contentLength) {
